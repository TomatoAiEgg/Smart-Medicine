...
export interface AdminOrderDetail {
  ...
  legacyCompanyNum: string | null;
  createIp: string | null;
  orderTime: string | null;
  classes: string | null;
  orderPkgWeight: number | string | null;
  orderPkgNum: number | null;
  logisticsReceivablesMoney: number | string | null;
  logisticsPayMethod: string | null;
...
export interface AdminOrderDetailPrescription {
  ...
  prescriptionRemark: string | null;
  patientAge: string | null;
  patientMonthAge: string | null;
  patientDayAge: string | null;
  patientGender: string | null;
  patientCardNo: string | null;
  treatCard: string | null;
  patientTel: string | null;
  isPregnant: string | null;
  herbType: string | null;
  wjType: string | null;
  doctorTel: string | null;
  hospitalName: string | null;
  hospitalNum: string | null;
  orderHandleFloor: string | null;
  jyjDecoctionPlan: string | null;
  jyjDecoctionAdvice: string | null;
  labelSize: string | null;
  bindNo: string | null;
  drugsMoney: number | string | null;
  auditFlowPicUrl: string | null;
  auditReason: string | null;
  auditResult: string | null;
  dispenseFlowPicUrl: string | null;
  recheckFlowPicUrl: string | null;
  detailCount: number;
  createdAt: string;
  details: AdminOrderDetailDrug[];
}
...
export interface AdminOrderDetailDrug {
  ...
  dcGoodsNum: string | null;
  dcGoodsName: string | null;
  rootsGoodsName: string | null;
  supplierName: string | null;
  medPerDose: number | string | null;
  medPerDay: number | string | null;
  detailStatus: string | null;
  note: string | null;
  waterAbsorbRatio: number | string | null;
  createdAt: string;
}
