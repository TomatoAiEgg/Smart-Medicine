...
export const menuItems = [
  ...
  },
  {
    ...
    coreActions: ['列表', '筛选', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['字典类型维护', '字典项维护', '缓存刷新'],
  },
  {
  ...
  },
  {
    ...
    coreActions: ['列表', '筛选', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['机构维护', '回调配置', '操作审计'],
  },
  {
    key: 'institutionApps',
    label: '机构应用配置',
    ...
    coreActions: ['应用列表', '新增', '编辑', '启停', '重置密钥', '导出'],
    apiDependencies: ['机构应用维护', '机构列表'],
  },
  {
    ...
    coreActions: ['白名单列表', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['IP 白名单维护', '访问日志'],
  },
  {
    key: 'institutionApis',
    label: '接口列表',
    ...
    coreActions: ['API 定义列表', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['API 定义维护'],
  },
  {
  ...
  },
  {
    ...
    coreActions: ['规则列表', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['物流费用规则维护', '操作审计'],
  },
  {
    ...
    coreActions: ['地址费用列表', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['地址费用维护'],
  },
  {
    key: 'logistics',
    label: '订单发货查询',
    ...
    priority: 'P1',
    implemented: true,
    subtitle: '处理待发货、发货、签收、浏览器面单和回调补偿',
    componentKey: 'logistics',
    showCount: true,
    plannedComponent: 'features/logistics/LogisticsFulfillment.vue',
    coreActions: ['发货查询', '打包发货', '发货/签收', '轨迹补录', '行级清单打印', '浏览器面单/重打', '导出'],
  ...
  },
  {
    ...
    coreActions: ['合单列表', '合并', '取消合单', '导出'],
    apiDependencies: ['合单查询', '合单保存', '合单取消'],
  },
  {
  ...
  },
  {
    ...
    apiDependencies: ['地址修改', '地址变更记录', '批量地址提交'],
  },
  {
  ...
  },
  {
    ...
    coreActions: ['拦截规则新增', '编辑', '启停', '导出'],
    apiDependencies: ['拦截规则维护', '操作审计'],
  },
  {
  ...
  },
  {
    ...
    priority: 'P1',
    implemented: true,
    subtitle: '签收确认和批量签收提交',
    componentKey: 'orderReceipt',
    plannedComponent: 'features/orders/OrderReceipt.vue',
    coreActions: ['手工签收', '批量签收提交', '导出'],
    apiDependencies: ['签收', '批量签收接口', '物流状态'],
  },
  {
    key: 'observability',
    label: '订单流程查询',
    ...
    showCount: true,
    plannedComponent: 'features/ops/OrderObservabilityPanel.vue',
  ...
  },
  {
    ...
    coreActions: ['模板列表', '新增', '编辑', '启停', '预览', '导出'],
    apiDependencies: ['标签模板维护', '标签预览', '操作审计'],
  },
  {
    key: 'labelPrints',
    label: '处方标签打印',
  ...
  },
  {
    ...
    coreActions: ['模板列表', '新增', '编辑', '启停', '预览', '导出'],
    apiDependencies: ['短信模板维护', '短信预览', '操作审计'],
  },
  {
    key: 'smsSendSingle',
    label: '单发短信',
  ...
  },
  {
    ...
    coreActions: ['索引列表', '新增', '编辑', '启停', '导出'],
    apiDependencies: ['药品索引维护', '重复检查'],
  },
  {
    key: 'drugHerbImports',
    label: '药品目录导入',
  ...
  },
  {
    ...
    showCount: true,
    plannedComponent: 'features/reports/ReportOverview.vue',
