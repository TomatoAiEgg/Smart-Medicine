...
export const menuItems = [
  {
    ...
    priority: 'P4',
    implemented: false,
    subtitle: '账号、登录用户和后台操作人员维护',
    plannedComponent: 'features/system/UserManage.vue',
    coreActions: ['列表', '筛选', '新增', '编辑', '启停', '改密', '授权'],
    apiDependencies: ['用户 CRUD', '角色列表', '用户授权', '操作审计'],
  },
  {
    key: 'systemRoles',
    label: '角色管理',
  ...
  },
  {
    ...
    implemented: false,
    subtitle: '调剂员绩效明细',
    plannedComponent: 'features/report/DispensePerformanceDetail.vue',
    coreActions: ['明细', '导出'],
  ...
  },
  {
    ...
    implemented: false,
    subtitle: '药材消耗统计',
    plannedComponent: 'features/report/HerbDosageReport.vue',
    coreActions: ['药材用量统计', '导出'],
    apiDependencies: ['药材用量统计', '导出任务'],
  },
  {
    key: 'decoction',
    label: '设备列表查询',
    ...
    showCount: true,
    plannedComponent: 'features/decoction/EquipmentList.vue',
    coreActions: ['设备列表', '新增', '编辑', '启停'],
    apiDependencies: ['设备 CRUD', '设备状态查询'],
  },
  {
    ...
    plannedComponent: 'features/decoction/PrescriptionBindingList.vue',
    coreActions: ['绑定查询', '解绑', '重绑'],
    apiDependencies: ['绑定记录', '设备冲突校验'],
  },
  {
    ...
    plannedComponent: 'features/decoction/PdaPrinterRelation.vue',
    coreActions: ['PDA/打码机关系配置'],
    apiDependencies: ['关系 CRUD', '操作审计'],
  },
  {
    ...
    implemented: false,
    subtitle: '加水桶列表和批量新增',
    plannedComponent: 'features/decoction/WaterPailManage.vue',
    coreActions: ['加水桶列表', '批量新增', '导出'],
    apiDependencies: ['加水桶 CRUD', '导出任务'],
  },
  {
    ...
    plannedComponent: 'features/decoction/CloudPrintRecord.vue',
    coreActions: ['打印记录', '失败重试', '重打'],
    apiDependencies: ['打印记录', '重试接口', '重打记录'],
  },
