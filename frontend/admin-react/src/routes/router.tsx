...
const ThirdBatchPages = {
  LabelTemplatePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ LabelTemplatePage }) => ({ default: LabelTemplatePage }))),
  LabelPrintPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ LabelPrintPage }) => ({ default: LabelPrintPage }))),
  SmsTemplatePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ SmsTemplatePage }) => ({ default: SmsTemplatePage }))),
  SmsSingleSendPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ SmsSingleSendPage }) => ({ default: SmsSingleSendPage }))),
  SmsRecordPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ SmsRecordPage }) => ({ default: SmsRecordPage }))),
  HerbListPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbListPage }) => ({ default: HerbListPage }))),
  HerbIndexOperationLogPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbIndexOperationLogPage }) => ({ default: HerbIndexOperationLogPage }))),
  HerbIndexPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbIndexPage }) => ({ default: HerbIndexPage }))),
  HerbImportPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbImportPage }) => ({ default: HerbImportPage }))),
  HerbIndexImportPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbIndexImportPage }) => ({ default: HerbIndexImportPage }))),
  HerbAreaPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbAreaPage }) => ({ default: HerbAreaPage }))),
  InstitutionPrescriptionCountsPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ InstitutionPrescriptionCountsPage }) => ({ default: InstitutionPrescriptionCountsPage }))),
  AuditPerformancePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ AuditPerformancePage }) => ({ default: AuditPerformancePage }))),
  AuditPerformanceDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ AuditPerformanceDetailPage }) => ({ default: AuditPerformanceDetailPage }))),
  DispensePerformancePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DispensePerformancePage }) => ({ default: DispensePerformancePage }))),
  DispensePerformanceDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DispensePerformanceDetailPage }) => ({ default: DispensePerformanceDetailPage }))),
  RecheckPerformancePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ RecheckPerformancePage }) => ({ default: RecheckPerformancePage }))),
  RecheckPerformanceDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ RecheckPerformanceDetailPage }) => ({ default: RecheckPerformanceDetailPage }))),
  DecoctionPerformancePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionPerformancePage }) => ({ default: DecoctionPerformancePage }))),
  DecoctionPerformanceDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionPerformanceDetailPage }) => ({ default: DecoctionPerformanceDetailPage }))),
  LogisticsPerformancePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ LogisticsPerformancePage }) => ({ default: LogisticsPerformancePage }))),
  LogisticsPerformanceDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ LogisticsPerformanceDetailPage }) => ({ default: LogisticsPerformanceDetailPage }))),
  InstitutionHerbReconciliationPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ InstitutionHerbReconciliationPage }) => ({ default: InstitutionHerbReconciliationPage }))),
  PrescriptionReconciliationPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ PrescriptionReconciliationPage }) => ({ default: PrescriptionReconciliationPage }))),
  PrescriptionHerbDetailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ PrescriptionHerbDetailPage }) => ({ default: PrescriptionHerbDetailPage }))),
  HerbDosagePage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ HerbDosagePage }) => ({ default: HerbDosagePage }))),
  DecoctionBindingPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionBindingPage }) => ({ default: DecoctionBindingPage }))),
  DecoctionPrinterPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionPrinterPage }) => ({ default: DecoctionPrinterPage }))),
  DecoctionWaterPailPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionWaterPailPage }) => ({ default: DecoctionWaterPailPage }))),
  DecoctionCloudPrintRecordPage: lazy(() => import('../features/operations/ThirdBatchPages').then(({ DecoctionCloudPrintRecordPage }) => ({ default: DecoctionCloudPrintRecordPage }))),
};
...
const implementedPages: Record<string, ReactNode> = {
  ...
  'labels-template': <ThirdBatchPages.LabelTemplatePage />,
  'labels-print': <ThirdBatchPages.LabelPrintPage />,
  'sms-templates': <ThirdBatchPages.SmsTemplatePage />,
  'sms-send-single': <ThirdBatchPages.SmsSingleSendPage />,
  'sms-records': <ThirdBatchPages.SmsRecordPage />,
  'drugs-herbs': <ThirdBatchPages.HerbListPage />,
  'drugs-index-logs': <ThirdBatchPages.HerbIndexOperationLogPage />,
  'drugs-indexes': <ThirdBatchPages.HerbIndexPage />,
  'drugs-herbs-import': <ThirdBatchPages.HerbImportPage />,
  'drugs-index-import': <ThirdBatchPages.HerbIndexImportPage />,
  'drugs-areas': <ThirdBatchPages.HerbAreaPage />,
  'decoction-equipment': <EquipmentListPage />,
  'reports-prescription-counts': <PrescriptionCountReportPage />,
  'reports-institution-counts': <ThirdBatchPages.InstitutionPrescriptionCountsPage />,
  'reports-audit-performance': <ThirdBatchPages.AuditPerformancePage />,
  'reports-audit-details': <ThirdBatchPages.AuditPerformanceDetailPage />,
  'reports-dispense-performance': <ThirdBatchPages.DispensePerformancePage />,
  'reports-dispense-details': <ThirdBatchPages.DispensePerformanceDetailPage />,
  'reports-recheck-performance': <ThirdBatchPages.RecheckPerformancePage />,
  'reports-recheck-details': <ThirdBatchPages.RecheckPerformanceDetailPage />,
  'reports-decoction-performance': <ThirdBatchPages.DecoctionPerformancePage />,
  'reports-decoction-details': <ThirdBatchPages.DecoctionPerformanceDetailPage />,
  'reports-logistics-performance': <ThirdBatchPages.LogisticsPerformancePage />,
  'reports-logistics-details': <ThirdBatchPages.LogisticsPerformanceDetailPage />,
  'reports-org-herbs': <ThirdBatchPages.InstitutionHerbReconciliationPage />,
  'reports-prescription-reconciliation': <ThirdBatchPages.PrescriptionReconciliationPage />,
  'reports-herb-details': <ThirdBatchPages.PrescriptionHerbDetailPage />,
  'reports-herb-dosage': <ThirdBatchPages.HerbDosagePage />,
  'decoction-bindings': <ThirdBatchPages.DecoctionBindingPage />,
  'decoction-printers': <ThirdBatchPages.DecoctionPrinterPage />,
  'decoction-water-pails': <ThirdBatchPages.DecoctionWaterPailPage />,
  'decoction-cloud-prints': <ThirdBatchPages.DecoctionCloudPrintRecordPage />,
};
